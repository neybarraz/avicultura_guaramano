# =============================================================================
# tabs/alimentacao.py
# MÓDULO INDEPENDENTE (não depende do app.py)
#
# Objetivo:
# - Ler dados/alimetacao.csv (ou alimentacao.csv)
# - Exibir gráficos de Mistura (%) e Consumo (g/ave/dia)
# - Abaixo de cada gráfico: diagnóstico zootécnico
#
# Regras visuais do diagnóstico:
# - Se DENTRO da faixa: texto branco, fundo transparente (mesmo “clima” do app)
# - Se FORA da faixa: texto vermelho
#
# Dependência interna do projeto:
# - domain/alimentacao_diagnostico.py (sem Streamlit)
# =============================================================================
...
# =============================================================================
MODULE_VERSION = "tabs/alimentacao.py + DIAG HTML v2026-01-06"
...
# Aparência da faixa de referência (verde transparente)
...
def _plot_timeseries(
    ...
    # Faixa de referência (verde transparente)
...
# =============================================================================
# 5. DIAGNÓSTICO (HTML/CSS controlado)
# =============================================================================
    ...
    st.markdown(
        ...
        <style>
          .diag-box {
            ...
            background: rgba(255,255,255,0.00); /* transparente */
            border: 1px solid rgba(255,255,255,0.12);
          }
          .diag-ok  { color: #ffffff; }  /* dentro da faixa */
          .diag-bad { color: #e57373; }  /* fora da faixa  */
          .diag-box h4 {
...
def render_tab(*args, **kwargs) -> None:
    ...
    # CSS do diagnóstico (uma vez por aba)
